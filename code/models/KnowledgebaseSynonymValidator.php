...
/**
 * This is copied from `SynonymValidator` in the `cwp/cwp` module.
 * The `SynonymValidator` is used in the `SynonymsSiteConfig` class which is we copied from `cwp/cwp`.
 * Our module we use the `KnowledgebaseSynonymValidator` class as a validator class in
 * `KnowlegebaseSynonymsSiteConfigExtension`
 *
 * Class KnowledgebaseSynonymValidator
 */
class KnowledgebaseSynonymValidator extends Validator
{
    /**
     * @var array
     */
